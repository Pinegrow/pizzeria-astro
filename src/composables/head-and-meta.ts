...
export const useHeadAndMeta = async (pageMeta: any) => {
  const {
    title: siteTitle,
  ...
  useHead({
    title, // title is either defined statically within the <page> custom block in pages or dynamically by adding it to the page's frontmatter, and it is resolved here.
